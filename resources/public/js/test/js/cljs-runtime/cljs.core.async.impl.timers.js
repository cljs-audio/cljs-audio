...
var i_43331 = (self__.level + (1));
while(true){
if((i_43331 <= (new_level + (1)))){
(update[i_43331] = self__.header);

var G__43332 = (i_43331 + (1));
i_43331 = G__43332;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43335 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43335[i]));
} else {
x__$2.forward.push((((i < links_43335.length))?(links_43335[i]):null));
}

if((i < links_43335.length)){
(links_43335[i] = x__$2);
} else {
links_43335.push(x__$2);
}
...
var i_43342 = (0);
while(true){
if((i_43342 <= self__.level)){
var links_43344 = (update[i_43342]).forward;
if((x__$1 === (((i_43342 < links_43344.length))?(links_43344[i_43342]):null))){
(links_43344[i_43342] = (x__$1.forward[i_43342]));

var G__43350 = (i_43342 + (1));
i_43342 = G__43350;
continue;
} else {
var G__43351 = (i_43342 + (1));
i_43342 = G__43351;
continue;
}
} else {
...
var G__43361 = nx;
var G__43362 = (level__$1 - (1));
x = G__43361;
level__$1 = G__43362;
continue;
} else {
var G__43364 = x;
var G__43365 = (level__$1 - (1));
x = G__43364;
level__$1 = G__43365;
continue;
}
