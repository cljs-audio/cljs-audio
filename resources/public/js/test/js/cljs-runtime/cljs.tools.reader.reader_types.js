...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43201 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43201(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43204 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43204(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43210 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43210(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43227 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43227(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43233 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43233(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43235 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43235(reader);
}
});
...
var G__43296 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43297 = s.append(c);
c = G__43296;
s = G__43297;
continue;
}
