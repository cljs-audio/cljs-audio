...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_43286 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_43286(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_43288 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_43288(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_43291 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_43291(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_43295 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_43295(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_43303 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_43303(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_43304 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_43304(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__43279,callback){
var map__43280 = p__43279;
var map__43280__$1 = cljs.core.__destructure_map(map__43280);
var input = map__43280__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43280__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43280__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
