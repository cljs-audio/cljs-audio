...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50912_SHARP_){
return html_coll.item(p1__50912_SHARP_);
...
return cljs.core.some((function (p1__50914_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__50914_SHARP_);
...
var ctx_50997 = cvs.getContext("2d");
(ctx_50997.fillStyle = color);

ctx_50997.fillRect((0),(0),size,size);
