...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40729 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40729(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40730 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40730(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40736 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40736(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40738 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40738(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40741 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40741(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40746 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40746(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40749 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40749(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40750 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40750(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40756 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40756(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40759 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40759(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40765 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40765(b);
}
});
